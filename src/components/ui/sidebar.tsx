...
>(({ asChild = false, isActive = false, className, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        'flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-ring transition-colors hover:bg-accent/50 hover:text-accent-foreground focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 data-[active=true]:bg-gradient-to-r from-primary/20 to-accent/20 data-[active=true]:font-medium data-[active=true]:text-foreground',
        className
      )}
      {...props}
    />
